...
package com.junkbyte.console.view
{
	...
	public class ConsolePanel extends Sprite
	{
		...
		private function onDraggerMouseDown(e:MouseEvent):void
		{
			...
			_dragOffset = new Point(mouseX, mouseY); // using this way instead of startDrag, so that it can control
			                                         // snapping.
			_snaps = [[], []];
		...
		private function onScalerMouseDown(e:Event):void
		{
			...
			updateScaleText();
			_dragOffset = new Point(scaler.mouseX, scaler.mouseY); // using this way instead of startDrag, so that it
			                                                       // can control snapping.
			_snaps = [[], []];
